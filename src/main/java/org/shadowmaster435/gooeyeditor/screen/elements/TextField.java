...
public class TextField extends ParentableWidgetBase {
    ...
    protected boolean focusUnlocked = true;
    ...
    protected Predicate<String> textPredicate = Objects::nonNull;
    ...
    public TextField(int x, int y, int w, int h, TextRenderer textRenderer, boolean editMode) {
        super(x, y, w, h, editMode);
        this.textRenderer = textRenderer;

    }
    public TextField(int x, int y, boolean editMode) {
        super(x, y, editMode);
    }

    @Override
    public Property[] getProperties() {
        var text = new Property("Text", "setText", "getText", String.class);
        var placeholder = new Property("Placeholder Text", "setPlaceholder", "getPlaceholder", String.class);
        return new Property[]{text, placeholder};
    }
    ...
    protected void erase(int offset) {
    ...
    public void setFocused(boolean focused) {
        if ((this.focusUnlocked || focused) && !this.isEditMode()) {
    ...
    public String getPlaceholder() {
        return (placeholder != null) ? placeholder.getString() : "";
    }
