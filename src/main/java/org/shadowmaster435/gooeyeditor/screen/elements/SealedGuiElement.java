...
public abstract sealed class SealedGuiElement implements Drawable, Selectable, Element, Widget permits GuiElement {
    //region Fields
    //region floats
    ...
    //endregion
    //region Init
    public SealedGuiElement(Drawable widget, int x, int y, boolean editMode) {
    ...
    /**
     * Default render function <p>
     * called before any transforms.
     */
    @Override
    ...
    /**
     * Iterates up until an element's parent is {@code null}.
     */
    public void forEachParent(Consumer<SealedGuiElement> consumer) {
        var actualParent = parent;
        while (actualParent instanceof SealedGuiElement element) {
    ...
    /**
     * Used to determine when to start running checks for what type of transform to do.
     */
    ...
    /**
     * Set where to render the tooltip.
     */
    ...
    /**
     * Set tooltip to provided string.
     */
    ...
    /**
     * Controls whether to offset element by {@code offset_x} and {@code offset_y}.
     */
    ...
    /**
     * Enables/Disables vanilla scissor.
     */
    ...
    /**
     * @return Bounds as seen in screenspace.
     */
    ...
    /**
     * Return an array of properties (see {@link Property} and {@link SealedGuiElement#getDefaultProperties()}) <p>
    ...
    /**
     * Draws an itemstack at the provided pos and size.
     * Lighting may be funky.
     * @param context
     */
    ...
    public void drawNinePatchTexture(DrawContext context, Rect2 rect, NinePatchTextureData data) {
        ...
        drawNinePatchTexture(context, rect, texture, edge_thickness);
    }

    public void drawNinePatchTexture(DrawContext context, Rect2 rect, Identifier texture, int edge_thickness) {
        var x = rect.x;
        var y = rect.y;
    ...
    public static <E extends GuiElement> E fromJson(JsonObject element, String elementName, boolean editMode) {
        E result;
    ...
    public void writeJson(JsonObject object) {
        ...
        if (this instanceof GuiElement e) {
            for (SealedGuiElement element : e.getElements()) {
    ...
    public void createChildInitString(ClassCodeStringBuilder.MethodStringBuilder builder, Class<?> clazz, String className, SealedGuiElement element, SealedGuiElement par, HashMap<String, Integer> usedNames, String safeParentName) {
